  ...
  (function () {
  	...
  	function handleFormSubmit(event) {
  		...
  		xhr.onreadystatechange = function () {
  			...
  			// 	var formElements = form.querySelector(".form-box__form");
  			// 	if (formElements) {
  			// 		formElements.style.display = "none"; // hide form
  			// 	}
  			// 	var thankYouMessage = form.querySelector(".form-box__thanks");
  			// 	if (thankYouMessage) {
  			// 		thankYouMessage.style.display = "block";
  			// 	}
  			// }
  			document.querySelector(".form-box").classList.add("submitted");
  			document.querySelector(".form-box__form").classList.remove("process");
  			form.reset();
  		};
